  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appApp.orden.home.createOrEditLabel" data-cy="OrdenCreateUpdateHeading">
            <Translate contentKey="appApp.orden.home.createOrEditLabel">Create or edit a Orden</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('appApp.orden.cliente')} id="orden-cliente" name="cliente" data-cy="cliente" type="text" />
              <ValidatedField
                label={translate('appApp.orden.accionId')}
                id="orden-accionId"
                name="accionId"
                data-cy="accionId"
                type="text"
              />
              <ValidatedField label={translate('appApp.orden.accion')} id="orden-accion" name="accion" data-cy="accion" type="text" />
              <ValidatedField
                label={translate('appApp.orden.operacion')}
                id="orden-operacion"
                name="operacion"
                data-cy="operacion"
                type="text"
              />
              <ValidatedField
                label={translate('appApp.orden.cantidad')}
                id="orden-cantidad"
                name="cantidad"
                data-cy="cantidad"
                type="text"
              />
              <ValidatedField label={translate('appApp.orden.precio')} id="orden-precio" name="precio" data-cy="precio" type="text" />
              <ValidatedField
                label={translate('appApp.orden.fechaOperacion')}
              ...
              />
              <ValidatedField label={translate('appApp.orden.modo')} id="orden-modo" name="modo" data-cy="modo" type="text" />
              <ValidatedField
                label={translate('appApp.orden.operacionExitosa')}
              ...
              />
              <ValidatedField
                label={translate('appApp.orden.operacionObservaciones')}
