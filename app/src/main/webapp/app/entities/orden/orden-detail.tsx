    ...
    <Row>
      <Col md="8">
        <h2 data-cy="ordenDetailsHeading">
          <Translate contentKey="appApp.orden.detail.title">Orden</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="accion">
              <Translate contentKey="appApp.orden.accion">Accion</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="precio">
              <Translate contentKey="appApp.orden.precio">Precio</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="modo">
              <Translate contentKey="appApp.orden.modo">Modo</Translate>
            </span>
          </dt>
